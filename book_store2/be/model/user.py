...
from table_info import User as UserTableInfo
...
class User(db_conn.DBConn):
    ...
    def check_token(self, user_id: str, token: str) -> (int, str):
        res = self.get_user_by_id(user_id=user_id)
        if res is None:
    ...
    def check_password(self, user_id: str, password: str) -> (int, str):
        ...
        # )
        # row = cursor.fetchone()
        user_one = self.get_user_by_id(user_id=user_id)
    ...
    def login(self, user_id: str, password: str, terminal: str) -> (int, str, str):
        ...
        try:
            ...
            # )
            cursor = self.get_user_by_id_ex(user_id=user_id)
            cursor.token = token
    ...
    def change_password(
        ...
        try:
            ...
            # self.conn.commit()
            cursor = self.get_user_by_id(user_id=user_id)
